...
public class MainApp extends Application {
	...
	public static void main(String[] args) {
    	launch(args);
		//int arr[] = {10, 3 ,5 ,6 ,7,93, 44 , 55};
	}




//	List<String> getTokens (String document, String pattern) {
//    	List<String> tokens = new ArrayList<>();
//    	// Compiles a pattern
//		Pattern tokenSplitter = Pattern.compile(pattern);
//		// initializing matcher with a pattern
//		Matcher matcher = tokenSplitter.matcher(document);
//		// finding recurring patterns and addint it to the token list
//		while (matcher.find())
