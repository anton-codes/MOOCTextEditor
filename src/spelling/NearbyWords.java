...
public class NearbyWords implements SpellingSuggest {
	...
	public List<String> suggestions(String word, int numSuggestions) {
		...
		while (!queue.isEmpty() && retList.size() < numSuggestions) {
			...
			currString = queue.remove(0);

			if (dict.isWord(currString)) retList.add(currString);

			deletions(currString, queue, true);
			substitution(currString, queue, true);
			insertions(currString, queue, true);
